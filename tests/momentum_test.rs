...
fn test_inertia() {
    let stats = common::test_data();
    let result = momentum::inertia(&stats.close, 6, 10);
    assert_eq!(
        vec![
            33.846695422163236,
            37.0863925832691,
...
fn test_chop() {
    let stats = common::test_data();
    let result = momentum::chop(&stats.high, &stats.low, &stats.close, 16);
    assert_eq!(
        vec![
            35.50305865709021,
            29.36528182694797,
...
fn test_aroon() {
    let stats = common::test_data();
    let result = momentum::aroon(&stats.high, &stats.low, 16);
    assert_eq!(
        vec![
            (12.5, 100.0),
            (6.25, 100.0),
