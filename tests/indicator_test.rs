...
fn test_roc() {
    let stats = common::test_data();
    let result = indicator::roc(&stats.close, 16);
    assert_eq!(
        vec![
            -13.043478260869568,
            -31.2040135208693,
...
fn test_keltner() {
    let stats = common::test_data();
    let result = indicator::keltner(&stats.high, &stats.low, &stats.close, 16);
    assert_eq!(
        vec![
...
fn test_gri() {
    let stats = common::test_data();
    let result = indicator::gri(&stats.high, &stats.low, 16);
    assert_eq!(
        vec![
            1.2845807635148472,
            1.2882486699344737,
